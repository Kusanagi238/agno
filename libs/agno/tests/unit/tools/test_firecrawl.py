...
try:
    ...
    # Defer or tolerate missing "firecrawl" package during test collection
    FirecrawlApp = None

try:
    from agno.tools.firecrawl import FirecrawlTools
except Exception:
    # The wrapper may raise if the optional dependency isn't installed; avoid failing import
    FirecrawlTools = None
