...
try:
    ...
    # firecrawl-py may not be installed in some test environments/CI; provide a lightweight stub
    FirecrawlApp = Mock()

try:
    from agno.tools.firecrawl import FirecrawlTools
except Exception:
    # If the local module import triggers due to missing external dependency, stub it to allow collection
    FirecrawlTools = Mock()
