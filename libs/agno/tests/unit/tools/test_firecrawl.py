...
# Avoid importing third-party 'firecrawl' and local agno.tools.firecrawl at module import time.
# Import them lazily inside fixtures/tests or provide mocks if unavailable.
try:
    from firecrawl import FirecrawlApp
except Exception:
    FirecrawlApp = None

# Defer importing agno.tools.firecrawl to avoid import-time dependency issues.
# Tests should import or mock FirecrawlTools in fixtures as needed.
FirecrawlTools = None
