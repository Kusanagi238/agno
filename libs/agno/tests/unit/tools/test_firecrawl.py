...
# Defer importing external packages that may not be installed at collection time.
# Tests or fixtures should import these inside functions, or tests can patch them.
try:
