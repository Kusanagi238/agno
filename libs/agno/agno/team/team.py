...
class Team:
    ...
    # Optional agent id to allow treating Team in contexts where Agent.agent_id is expected
    ...
    def __init__(
        ...
        # Optional agent_id to satisfy union attribute access where Team may be treated like Agent
        self.agent_id = None
    ...
    def _find_member_by_id(self, member_id: str) -> Optional[Tuple[int, Union[Agent, "Team"]]]:
        ...
        for i, member in enumerate(self.members):
            # Guard attribute access on Union[Agent, Team] by checking type first
            if (hasattr(member, "name") and member.name) or (isinstance(member, Agent) and member.agent_id is not None):
                url_safe_member_id = self._get_member_id(member)
