...
# Note: ScrapeOptions may not be present in all firecrawl versions. Import ScrapeOptions
# inside functions or construct it at runtime where needed to avoid import-time failures.
