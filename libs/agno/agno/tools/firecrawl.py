...
try:
    ...
    try:
        ...
        try:
            ...
            raise ImportError(
                "Could not import 'ScrapeOptions' from 'firecrawl'. The installed package may expose a different symbol (e.g. 'V1ScrapeOptions'). "
                "Please install a compatible 'firecrawl-py' version or adjust the import."
            ) from inner_exc
except ImportError as e:
    raise ImportError("`firecrawl-py` not installed or could not be imported. Original error: {}".format(e))
