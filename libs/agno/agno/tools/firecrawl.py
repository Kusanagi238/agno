...
try:
    ...
    # ScrapeOptions is not available in the installed firecrawl package. Provide a
    # minimal fallback that accepts arbitrary options and stores them as attributes.
    class ScrapeOptions:
